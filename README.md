...
In addition to the [howto.pdf](PDF version of the guide itself), you can find all of the code and data used on the GitHub repository for this guide in the current repository, with the original pdf version and relevant code on [this repository](https://github.com/JoshMerfeld/geospatialSAEhowto). The relevant code are:
